...
./nntool -v --threads 1 --adaptive --samples 20000 iris-test.ds 4-10-10-10-10-1 iris-nn.cfg bayes

##################################################
# testing

./nntool -v iris-test.ds 4-10-10-10-10-1 iris-nn.cfg use
...
./nntool -v iris-pred.ds 4-10-10-10-10-1 iris-nn.cfg use
