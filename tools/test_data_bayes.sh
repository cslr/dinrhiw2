...
# ./nntool --samples 100 -v wine-test.ds 13-10-1 winenn.cfg lbfgs
./nntool --samples 10000 --adaptive -v wine-test.ds 13-10-1 winenn.cfg bayes

# testing

./nntool -v wine-test.ds 13-10-1 winenn.cfg use
