...
./nntool -v --samples 20 wdbc-test.ds 30-30-30-1 wdbcnn.cfg bfgs

##################################################
# testing

./nntool -v wdbc-test.ds 30-30-30-1 wdbcnn.cfg use
...
./nntool -v wdbc-pred.ds 30-30-30-1 wdbcnn.cfg use
