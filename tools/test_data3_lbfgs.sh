...
# lbfgs: error reduces down to 0.192288
# lbfgs (stochastic goes to lower): error is 0.159,
#                                   average error in dataset 0.042
# grad: 0.066
...
ARCH="141-141-141-141-141-141-141-4"
...
./nntool -v --samples 100 --threads 1 commviol-test.ds $ARCH commviol-nn.cfg lbfgs
##./nntool -v --samples 100 --threads 1 commviol-test.ds $ARCH commviol-nn.cfg grad
