...
./nntool -v --samples 50 --threads 1 --overfit commviol-test.ds 141-141-141-141-141-4 commviol-nn.cfg lbfgs

##################################################
# testing

./nntool -v commviol-test.ds 141-141-141-141-141-4 commviol-nn.cfg use
...
./nntool -v commviol-pred.ds 141-141-141-141-141-4 commviol-nn.cfg use
