 ...
 * for neural network training using dataset data.
 *
 * Implements restart sampling, estimates convergence and once it has happened restarts sampler at random position.
 *
 * (C) Copyright 2016, 2023 Tomas Ukkonen
 */
